 ...
 *
 * Revision history:
 *********** Facilities added by Ohia Goodstar 17 June 2024 (constant)
 ...
 *
 */
void define_name(char declkey, string var, double val)
{
	if (is_declared(var))
		error(var, " declared twice");
	var_table.push_back(Variable{declkey, var, val});
}

/**
 * set_value - assign new value / expression to non const Variable
...
double declaration()
{
	...
	define_name(constkey.kind, var_name, d);
	return d;
}
...
try
{
	cout << "Welcome to our simple calculator.\n"
	     ...
	     << " to quit program\n";
	// predefined names
	define_name(con, "pi", 3.1415926535); // pi is a constant
	define_name(con, "e", 2.7182818284); // e is a constant
